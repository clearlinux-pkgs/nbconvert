...
%prep
%setup -q -n nbconvert-6.2.0
cd %{_builddir}/nbconvert-6.2.0
...
cp %{_builddir}/nbconvert-6.2.0/LICENSE %{buildroot}/usr/share/package-licenses/nbconvert/4864371bd27fe802d84990e2a5ee0d60bb29e944
