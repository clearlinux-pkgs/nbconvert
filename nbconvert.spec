...
Version  : 5.3.0
Release  : 7
URL      : https://pypi.debian.net/nbconvert/nbconvert-5.3.0.tar.gz
Source0  : https://pypi.debian.net/nbconvert/nbconvert-5.3.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1504229815
